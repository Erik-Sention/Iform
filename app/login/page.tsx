...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex">
      {/* Vänster sida - Bild */}
      <div className="hidden lg:flex lg:w-[62%] relative">
        <Image
          src="/images/Aktivitus_Channel_OmAktivitus.png"
          alt="Aktivitus"
          fill
      ...
      {/* Höger sida - Inloggning */}
      <div 
        className="w-full lg:w-[38%] flex items-center justify-center px-4 py-8"
